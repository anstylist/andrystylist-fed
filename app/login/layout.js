  ...
  return (
    <html lang="en">
      <Head>
        ...
        <meta name="keywords" content="hair, skincare, style, beauty, haircut, hairstyle, makeup, makeup artist, glam, glamour, andry, peña, bride, andrystylist, maquillaje, peinados, cortes, productos, entrepreneurship, woman, content creator, influencer, creadora de contenido, fiance, novia, login" />
      ...
      <body className={font.className}>
        <h1 className='home__main-title'>Andry Peña Login Page</h1>
        <div id="root">
          {children}
        </div>
      </body>
