...
const SignUpForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const signUpUserData = await AuthService.signUp(signUpUser)
      setError(null)

      setRegisteredUser(signUpUserData)
    } catch (error) {
      setError(error)
    } finally {
      setIsLoading(false);
        ...
        <section className="sign-up-form__container">
          ...
          {!registeredUser && (
            <form className="sign-up-form__form" onSubmit={handleSubmit}>
              ...
              <div className='sign-up-form__alert-box'>
              ...
              <TextField
                ...
                inputProps={{ maxLength: 250, autoComplete: 'off' }}
                required
                onChange={handleChange}
              />
              <TextField
          ...
          {registeredUser && (
            <div className="sign-up-form__form">
              ...
              <Alert variant="outlined" severity="success" className="sign-up-form__form--success">
                <AlertTitle>Only just one last step</AlertTitle>
                Your account has been created successfully.
                You will receive a message in your inbox to confirm your email to start enjoying our services.
              </Alert>
            </div>
          )}
